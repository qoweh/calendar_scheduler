...
class $SchedulesTable extends Schedules
  ...
  @override
  late final GeneratedColumn<int> startTime =
  ...
  @override
  late final GeneratedColumn<int> endTime =
      GeneratedColumn<int>('end_time', aliasedName, false,
          type: DriftSqlType.int,
          requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns =>
      [id, content, date, startTime, endTime];
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('start_time')) {
      context.handle(
          ...
          startTime.isAcceptableOrUnknown(
              data['start_time']!, _startTimeMeta));
    } else if (isInserting) {
    ...
    if (data.containsKey('end_time')) {
      context.handle(
          _endTimeMeta,
          endTime.isAcceptableOrUnknown(
              data['end_time']!, _endTimeMeta));
    } else if (isInserting) {
  ...
  @override
  Schedule map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix =
        tablePrefix != null ? '$tablePrefix.' : '';
    return Schedule(
      id: attachedDatabase.typeMapping.read(
          DriftSqlType.int, data['${effectivePrefix}id'])!,
...
class Schedule extends DataClass
    implements Insertable<Schedule> {
  final int id;
  ...
  factory Schedule.fromJson(Map<String, dynamic> json,
    ...
    return Schedule(
      ...
      startTime:
          serializer.fromJson<int>(json['startTime']),
  ...
  Schedule copyWithCompanion(SchedulesCompanion data) {
    return Schedule(
      ...
      content: data.content.present
          ? data.content.value
          : this.content,
      date: data.date.present ? data.date.value : this.date,
      startTime: data.startTime.present
          ? data.startTime.value
          : this.startTime,
      endTime: data.endTime.present
          ? data.endTime.value
          : this.endTime,
    );
  }
  ...
  @override
  int get hashCode =>
      Object.hash(id, content, date, startTime, endTime);
  @override
...
abstract class _$LocalDatabase extends GeneratedDatabase {
  ...
  $LocalDatabaseManager get managers =>
      $LocalDatabaseManager(this);
  late final $SchedulesTable schedules =
      $SchedulesTable(this);
  @override
...
class $$SchedulesTableAnnotationComposer
  ...
  GeneratedColumn<int> get id => $composableBuilder(
      column: $table.id, builder: (column) => column);
  ...
  GeneratedColumn<DateTime> get date => $composableBuilder(
      column: $table.date, builder: (column) => column);
  ...
  GeneratedColumn<int> get endTime => $composableBuilder(
      column: $table.endTime, builder: (column) => column);
}
...
class $$SchedulesTableTableManager extends RootTableManager<
    ...
    (
      Schedule,
      BaseReferences<_$LocalDatabase, $SchedulesTable,
          Schedule>
    ),
    Schedule,
    PrefetchHooks Function()> {
  $$SchedulesTableTableManager(
      _$LocalDatabase db, $SchedulesTable table)
